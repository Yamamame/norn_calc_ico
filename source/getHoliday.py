...
dtfrom = date(year=2020, month=1, day=1).isoformat() + "T00:00:00.000000Z"
dtto   = date(year=2020, month=12, day=31).isoformat() + "T00:00:00.000000Z"
...
print('')
for event in events:
    print('## {0}\t{1}'.format(event["start"]["date"], event["summary"]))
